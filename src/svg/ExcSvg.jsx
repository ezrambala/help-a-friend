...
export default function ExcSvg(){
    return(
        <svg fill="#a70000 " version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="14px" height="14px" viewBox="0 0 395.71 395.71" xmlspace="preserve" stroke="#a70000 " stroke-width="0.0039571" transform="matrix(1, 0, 0, 1, 0, 0)rotate(0)">
